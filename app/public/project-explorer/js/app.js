...
function updatesGraduationYears(){   
    ...
    return await fetch(req)
        ...
        .then(data => {
            if(data.status === 'ok'){
                ...
                alert = document.getElementById("signupAlert")
...
function register(){
    document.getElementById('signupButton').addEventListener('click', signUser)
    updatesPrograms()
    updatesGraduationYears()
}
